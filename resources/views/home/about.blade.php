...
<div class="container-fluid bg-secondary mb-5" style="background-image: url('images/about.png'); width: 100%">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center"
                style="background-image: url(images/anhshop.webp);">

            </div>
            <div class="col-md-7 py-md-5 wrap-about pb-md-5 ftco-animate">
                <div class="heading-section-bold mb-4 mt-md-5">
                    <div class="ml-md-0">
                        <h2 class="mb-4">Thành lập từ năm 2024</h2>
                    </div>
                </div>
                <div class="pb-md-5 pb-4">
                    <p>"Với tiêu chí "Chất lượng là ưu tiên hàng đầu", VnShop cam kết mang đến những sản phẩm thời trang
                        chất lượng cao, bền đẹp với thời gian."</p>
                    <p>"Đến với Vnshop, bạn sẽ không phải lo lắng về giá cả. Chúng tôi thường xuyên có các chương trình
                        ưu đãi đặc biệt dành cho khách hàng thân thiết."</p>
                ...
                <div class="carousel-testimony owl-carousel ftco-animate">
                    ...
                    <div class="item">
                        <div class="testimony-wrap">
                            ...
                            <div class="text">
                                <p class="mb-4 pl-4 line">Sản phẩm này đáp ứng được mong đợi của tôi về chất lượng và
                                    tính năng.</p>
                    ...
                    <div class="item">
                        <div class="testimony-wrap">
                            ...
                            <div class="text">
                                <p class="mb-4 pl-4 line">Sản phẩm dễ sử dụng và thích hợp cho cả người mới bắt đầu và
                                    người có kinh nghiệm.</p>
