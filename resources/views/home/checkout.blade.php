                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control @error('status') is-invalid @enderror" type="text"
                                    name="status" placeholder="Status" value="{{ old('status', 'pending') }}">
                                @error('status')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control @error('receiver') is-invalid @enderror" type="text"
                                    name="receiver" placeholder="receiver" value="{{ old('receiver') }}">
                                @error('receiver')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
